"""AmericanhospitalProject URL Configuration
...
urlpatterns = [
    ...
    path('', include("americanhospital_app.urls")),
...
#     url(r'^', include("americanhospital_app.urls")),
...
admin.site.site_header = 'AmericanhospitalProject Admin'
admin.site.site_title = 'AmericanhospitalProject Administration'
admin.site.index_title = 'AmericanhospitalProject Administration'
