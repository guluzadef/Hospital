...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if os.path.exists(venv_path):
            subprocess.call("rm -rf $(pwd)/americanhospital_app/templates/* && cp -r {}/lib/python{}/site-packages/oscar/templates/oscar/* $(pwd)/americanhospital_app/templates && cd americanhospital_app/templates && tree".format(venv_path, PYTHON_VERSION),shell=True)
